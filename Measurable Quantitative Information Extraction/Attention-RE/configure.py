...
def parse_args():
    ...
    parser.add_argument("--dev_sample_percentage", default=0.2,
                        type=float, help="Percentage of the training data to use for validation")

    # Model Hyper-parameters
    # Embeddings
    parser.add_argument("--embedding_path", default="embedding/flair_expermient_dict_corpus_lattice_word.vec",
                        type=str, help="Path of pretrain embedding"
                                       "re-trained word embeddings (glove)")
    ...
    parser.add_argument("--num_checkpoints", default=20,
    ...
    # Testing parameters
    parser.add_argument("--checkpoint_dir", default="runs/1593262796/",
    ...
    parser.add_argument("--gpu_allow_growth", default=True,
                        type=bool, help="Allow checkpoint_dir memory growth")
