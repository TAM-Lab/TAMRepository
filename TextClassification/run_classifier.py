...
class BertClassifier(nn.Module):
    def __init__(self, args, model):
        ...
        self.convs = nn.ModuleList(
              [nn.Conv1d(768, 256,k) for k in (2,3,4)])
            #[nn.Conv1d(1, 256, (k, 768)) for k in (2,3,4)])
        self.dropout = nn.Dropout(0.5)
        self.fc = nn.Linear(768, args.labels_num)
        #self.lstm = nn.LSTM(args.emb_size, 384, 2,bidirectional=True, batch_first=True, dropout=0.5)
...
def main():
    ...
    parser.add_argument("--output_model_path", default="/home/yuanxia/UER2020/models/classifier_model.bin", type=str,
